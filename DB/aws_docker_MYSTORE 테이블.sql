...
CREATE TABLE "TBL_EMPLOYEE" (
	...
	"EMP_AUTH"	VARCHAR2(900)	DEFAULT 'PS004'	NULL,
    "EMP_RANK"	VARCHAR2(900)	DEFAULT 'RK004'	NULL,
...
CREATE TABLE "TBL_COMMON_CODE" (
    ...
    "CLASSIFICATION_NO" 	VARCHAR2(300)		NULL,
...
COMMENT ON COLUMN "TBL_COMMON_CODE"."CLASSIFICATION_NO" IS '분류명';

COMMENT ON COLUMN "TBL_COMMON_CODE"."CLASSIFICATION_NAME" IS '분류명';
...
CREATE TABLE TBL_BOARDTYPE (
    ...
    BOARDT_NAME      VARCHAR2(200),
    BOARDT_TYPE      CHAR(1),
    BOARDT_READ      VARCHAR2(300),
    BOARDT_WRITE     VARCHAR2(300),
    BOARDT_CONTENT   VARCHAR2(300),
    BOARDT_USE       CHAR(1),
...
CREATE TABLE "TBL_DEP_TRANSFER" (
    TRANSFER_CODE VARCHAR2(100) NOT NULL,
    TRANSFER_BEFORE VARCHAR2(100),
    TRANSFER_AFTER VARCHAR2(100),
    TRANSFER_DATE DATE,
    "EMP_NO"	NUMBER		NULL,
    CREATE_DATE DATE DEFAULT SYSDATE,
    MODIFIER NUMBER,
...
BOARDFILE_NO NUMBER NOT NULL, -- 첨부파일번호
FILE_PATH VARCHAR2(2000), -- 파일 경로
FILESYSTEM_NAME VARCHAR2(2000), -- 시스템 파일명
ORIGINAL_NAME VARCHAR2(2000), -- 원본 파일명
UPLOAD_DATE DATE DEFAULT SYSDATE, -- 업로드 일자
REF_TYPE CHAR(1), -- 참조 게시판
REF_NO NUMBER, -- 참조 게시글 번호
CREATER VARCHAR2(150), -- 생성자
CREATE_DATE DATE DEFAULT SYSDATE, -- 생성일
MODIFIER VARCHAR2(150), -- 수정자
MODIFY_DATE DATE DEFAULT SYSDATE, -- 수정일
USE_YN CHAR(1) DEFAULT 'Y' -- 사용유무 (Y/N)
);
...
ALTER TABLE "TBL_DEP_TRANSFER" ADD CONSTRAINT "PK_TBL_DEP_TRANSFER" PRIMARY KEY (
	"TRANSFER_CODE"
);

ALTER TABLE "TBL_BOARDFILE" ADD CONSTRAINT "PK_TBL_BOARDFILE" PRIMARY KEY (
	"BOARDFILE_NO"
);
