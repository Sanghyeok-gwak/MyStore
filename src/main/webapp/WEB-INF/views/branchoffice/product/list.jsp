          ...
          <div class="ordering-detail">
            ...
            <div class="ordering-detail-text">
              <div class="ordering-detail-product-no">
                <span class="ffont2" id="product-id">-</span>
              </div>
              <div class="ordering-detail-product-name">
                <span class="ffont1" id="product-name">-</span>
              </div>
              <div class="ordering-detail-product-box1">
                <div class="ordering-detail-product-cost">
                  ...
                  <div class="ordering-detail-product-cost-price">
                    <span class="ffont2" id="product-cost">-</span>
                  </div>
                </div>
                <div class="ordering-detail-product-sail-price" style="margin-left: 20px;">
                  ...
                  <div class="ordering-detail-product-sail-price-price">
                    <span class="ffont2" id="product-sail-price">-</span>
                  </div>
                </div>
              </div>
              <div class="ordering-detail-product-box2">
                <div class="ordering-detail-product-expiration">
                  ...
                  <div class="ordering-detail-product-expiration-expiration">
                    <span class="ffont2" id="product-expiration">-</span>
                  </div>
                </div>
                <div class="ordering-detail-product-delivery-date">
                  ...
                  <div class="ordering-detail-product-delivery-date-date">
                    <span class="ffont2" id="product-delivery">-</span>
                  </div>
                </div>  
              </div>
            </div>
	...
	<script>
		  document.querySelectorAll('.product-row').forEach(function(row) {
		    row.addEventListener('click', function() {
		      ...
		      const sailPrice = this.getAttribute('data-sailprice');
		      ...
		      document.getElementById('product-cost').textContent = cost;
		      document.getElementById('product-sail-price').textContent = sailPrice;
		      document.getElementById('product-expiration').textContent = expiration;
		      document.getElementById('product-delivery').textContent = delivery;
		
		      document.getElementById('preview').src = productImg;
		
		      document.querySelector('.ordering-detail-text').style.display = 'flex';
		      document.querySelector('.ordering-detail-img').style.display = 'block';
		    });
		  });
		</script>
