		...
		<div class="note-side">
		  ...
		  <div class="note-side-a-box">
		      <ul style="padding-left:0px!important;">
		          ...
		          <li>
		              <a href="${contextPath}/note/send.no" style="color: red;">보낸쪽지함</a><br>
		          </li>
		          <li>
	  ...
	  <div class="btn-box4" style="display: flex; justify-content: end; margin-bottom: 20px;">
            ...
            <ul id="paging_area" class="pagination d-flex justify-content-center">
              ...
              <li class="page-item ${ pi.currentPage == 1 ? 'disabled' : '' }">
              	<a class="page-link" href="${contextPath }/note/send.no?page=${pi.currentPage-1}"><i class="bi bi-chevron-double-left"></i><span>이전</span></a>
              </li>
              
              <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
              	<li class="page-item ${ pi.currentPage == p ? 'active' : '' }">
              		<a class="page-link" href="${contextPath }/note/send.no?page=${p}">${ p }</a>
              	</li>
              </c:forEach>
              
              <li class="page-item ${ pi.currentPage == pi.maxPage ? 'disabled' : '' }">
              	<a class="page-link" href="${contextPath }/note/send.no?page=${pi.currentPage+1}"><span>다음</span>&nbsp;<i
