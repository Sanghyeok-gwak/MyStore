...
<body>
	...
	<div class="body-body">
		<div class="text-box">
			...
			<!-- 중간1 start-->
			<form action="${contextPath}/edoc/draftprogressListsearch.do"
				method="get">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="fl" items="${ list }">
									<tr onclick='location.href = "${contextPath}/edoc/draftprogress.do?no=${ fl.edocNo }";'>
										<td>${ fl.edocNo }</td>
										<td>${ fl.sampleNo }</td>
										<td>${ fl.edocTitle }</td>
										<td>${ fl.startDt }</td>
				...
				<div class="paging">
					<ul class="pagination d-flex justify-content-center text-dark"
						...
						<li class="page-item ${ pi.currentPage == 1 ? 'disabled' : '' }">
							<a class="page-link"
							href="${ contextPath }/edoc/draftprogressList.do?page=${pi.currentPage-1}">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							<li class="page-item ${ pi.currentPage == p ? 'active' : '' }">
								<a class="page-link"
								href="${ contextPath }/edoc/draftprogressList.do?page=${p}">${p}</a>
							</li>
						</c:forEach>
