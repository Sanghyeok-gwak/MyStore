...
<body>
	...
	<div class="body-body">
		<div class="text-box">
			...
			<!-- 중간1 start-->
			<form action="${contextPath}/edoc/draftrejectListsearch.do"
				method="get">
				...
				<div class="paging">
					<ul class="pagination d-flex justify-content-center text-dark"
						...
						<li class="page-item ${ pi.currentPage == 1 ? 'disabled' : '' }">
							<a class="page-link"
							href="${ contextPath }/edoc/draftrejectList.do?page=${pi.currentPage-1}">
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
							<li class="page-item ${ pi.currentPage == p ? 'active' : '' }">
								<a class="page-link"
								href="${ contextPath }/edoc/draftrejectList.do?page=${p}">${p}</a>
							</li>
						</c:forEach>
