	...
	<div class="body-body">
     <form action="">
          ...
          <div id="enddiv">
            ...
            <div class="btn-box-hover">
              <button class="btn1-hover" style="width: 120px; margin-left: 20px; font-size: 18px;">뒤로가기</button>
            </div>
          </div>
          <!-- 끝 end-->
            ...
            <div class="modal-dialog">
              <div class="modal-content" style="width: 800px; height: 600px;">
                ...
                <div class="modal-body d-flex">
                  <!-- 결재선 트리 표시 영역 -->
                  <div id="approvalTree" style="max-height: 500px; overflow-y: auto; width: 50%;"></div>
	...
	<script>
		$(function () {
		  ...
		  $("#approvalTree").jstree({
		      ...
		      $('#approvalTree').on("changed.jstree", function (e, data) {
		          ...
		          $selectedList.empty();
		            ...
		            $('#approvalTree').jstree("deselect_node", data.node.id); // 마지막 선택된 노드를 해제
		            return; // 추가 처리를 중지
		          }
		          ...
		          selectedNodes.forEach(function (nodeId) {
		              let node = $('#approvalTree').jstree(true).get_node(nodeId);
		              if (node) {
		                  // 결재자의 부모 노드(부서) 가져오기
		                  let parentNode = $('#approvalTree').jstree(true).get_node(node.parent);
		                  ...
		                  $selectedList.append('<li class="list-group-item">' + approverInfo + '</li>');
		              }
		          });
